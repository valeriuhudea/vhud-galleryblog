...
class AlbumImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AlbumImage
        fields = ('album', 'image', 'thumbnail', 'alt', 'created', 'tags', 'width', 'height', 'slug')

class AlbumSerializer(serializers.ModelSerializer):
    #owner = serializers.ReadOnlyField(source='owner.username')
    album_img = AlbumImageSerializer(many=True, read_only=True, source='album')
    
    class Meta:
        model = Album
        fields = ('title', 'description', 'thumbnail', 'tags', 'album_img', 'is_visible', 'created', 'modified', 'slug')
